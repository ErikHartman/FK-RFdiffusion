...
The Feynman-Kac (FK) method is model agnostic, however, the main implementation was done with RFdiffusion. This directory contains a standalone adapter module that can be used to implement FK for other models. You can therefore write your own adapter and run FK using your model.
